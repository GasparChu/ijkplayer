...
IJK_FFMPEG_UPSTREAM=https://github.com/GasparChu/FFmpeg.git
IJK_FFMPEG_FORK=https://github.com/GasparChu/FFmpeg.git
IJK_FFMPEG_COMMIT=ff3.4-ijk0.8.7-20181102-001-networkErr
